...
public class ListGraph<V, E> extends AbstractGraph<V, E>{
    ...
    /**
     *  @MethodName bfs
     *  @Description  参考树的层序遍历,引出图的广度优先搜索
     */
    @Override
    ...
    /**
     *  @MethodName dfs
     *  @Description  参照树的先序遍历,可以写出树的深度优先搜索
     *  迭代(栈)实现
     */
    ...
    /**
     *  @MethodName mst (Minimum Spanning Tree)
     *  @Description 最小生成树(总权值最小的生成树)
     */
    @Override
    ...
    private Set<EdgeInfo<V, E>> kruskal() {
        ...
        while (!heap.isEmpty() && edgeInfos.size() < edgeSize) {
            Edge<V, E> edge = heap.remove();
            if (uf.isSame(edge.from, edge.to))  //判断是否成环
                continue;   // 成环抛弃这条边
...
//		return dijkstra(begin);
    ...
    private Map<V, PathInfo<V, E>>  dijkstra(V begin) {
        ...
        Map<V, PathInfo<V, E>> selectedPaths = new HashMap<>(); // 最终的最短路径(被提起的石头)
